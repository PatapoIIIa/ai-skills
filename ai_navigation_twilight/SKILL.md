...
- For TGUI/browser UI tasks, bind this base with `$ss13-tgui`: use `tgui_guide.md` for Twilight facts and `ss13-tgui` for framework invariants.
...
| TGUI/web UI and assets | tgui_guide.md plus $ss13-tgui |
...
5. Recheck `tgui_guide.md` against actual backend/frontend files, and bind with `$ss13-tgui`.

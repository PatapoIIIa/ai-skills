...
| Hard delete / qdel warning | cleanup contract broken | Destroy/qdel path + $byond-ss13-coding |
| Cannot execute proc on deleted object | timer/signal callback outlived owner | signal_map.md + cleanup |
| TGUI minified/fatal JS error | frontend import/component/data shape | $ss13-tgui |
| Asset 404 / missing image | unregistered asset or stale mapping | $ss13-tgui (asset delivery) |
